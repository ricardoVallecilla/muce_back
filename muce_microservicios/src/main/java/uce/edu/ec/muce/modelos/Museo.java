...
public class Museo implements Serializable {
    ...
    @OneToMany(mappedBy = "museodestinoid")
    private Set<Movimiento> movimientoSet;
    @OneToMany(mappedBy = "museoemisorid")
    private Set<Movimiento> movimientoSet1;
    ...
    @XmlTransient
    public Set<Movimiento> getMovimientoSet1() {
        return movimientoSet1;
    }

    public void setMovimientoSet1(Set<Movimiento> movimientoSet1) {
        this.movimientoSet1 = movimientoSet1;
    }
